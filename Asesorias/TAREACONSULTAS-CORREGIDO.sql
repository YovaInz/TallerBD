...
--WHERE DATEPART(DW, V.FECHA) = 2, es mejor usar datepart en vez de datename
GO
...
/*
SELECT V.FOLIO, A.ARTNOMBRE, D.PRECIO, D.CANTIDAD
FROM VENTAS V
INNER JOIN DETALLE D ON D.FOLIO = V.FOLIO
INNER JOIN ARTICULOS A ON A.ARTID = D.ARTID
WHERE (D.CANTIDAD*D.PRECIO) BETWEEN 50 AND 100
*/
GO
