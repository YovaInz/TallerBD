...
GO
ALTER TABLE REGISTRO ADD CONSTRAINT pkRegistro PRIMARY KEY (FOLIO, CONID)
GO
...
CONSTRAINT pkRegistroXEventos PRIMARY KEY (FOLIO, CONID, EVEID)
GO
...
GO
ALTER TABLE REGISTROXEVENTOS ADD
CONSTRAINT fkUnionRegistro FOREIGN KEY (FOLIO, CONID) REFERENCES REGISTRO (FOLIO, CONID),
...
GO
INSERT INTO REGISTROXEVENTOS (FOLIO, CONID, EVEID, COSTO) VALUES
(1,1,5,100.00),
(2,2,4,150.00),
(3,3,3,200.00),
(4,4,2,50.00),
