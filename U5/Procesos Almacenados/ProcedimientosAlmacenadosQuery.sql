...
GO
-- EJECUCION
exec SP_REGRESO 3 --  el n�mero 3 representa el valor que se pasa al par�metro @EMP en tu procedimiento almacenado SP_REGRESO. 
				  --  As� que est� obteniendo los pedidos del empleado con la ID 3.
